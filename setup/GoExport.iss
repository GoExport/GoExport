...
Source: "..\redist\VC_redist.x64.exe"; DestDir: "{app}\vendor"
...
Filename: {app}\vendor\VC_redist.x64.exe; Parameters: "/install /quiet /norestart"; StatusMsg: Installing MSVC 2015-2022 64 bit RunTime...; Check: IsWin64; Flags: waituntilterminated
